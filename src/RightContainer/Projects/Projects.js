            ...
            <div className="project-bottom-container">
                <div className="single-project-container">
                    <div className="single-project-left-container">
                        <img src="/calculator.png" width="300px" alt="calculator"/>
                    </div>
                    <div className="single-project-right-container">
                        ...
                        <p> 
                            ...
                            <button className='demo-btn' onClick={()=> {window.open("https://loan-emi-calc.000webhostapp.com/")}}>Live Demo</button>
                        </p>
                    </div>
                </div>
                <div className="single-project-container">
                    <div className="single-project-left-container">
                    <img src="/notebook.png" width="300px" alt="notebook"/>
                    </div>
                    <div className="single-project-right-container">
